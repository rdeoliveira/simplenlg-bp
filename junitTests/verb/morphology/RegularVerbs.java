...
/**
 * This class tests conjugation of regular verbs.
 * The mechanism is employed to a VP by the Morphophonology package.
 */
public class RegularVerbs extends Setup {
	...
	public void testFirstConjugation(){
		...
		Assert.assertEquals(
				"cantaríamos", realiser.realise(cantar).getRealisation());
		...
		cantar.setFeature(Feature.NUMBER, NumberAgreement.SINGULAR);
		Assert.assertEquals(
				"cantarei", realiser.realise(cantar).getRealisation());
		...
		cantar.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"cantaremos", realiser.realise(cantar).getRealisation());
		...
		cantar.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"cantávamos", realiser.realise(cantar).getRealisation());
		...
		cantar.setFeature(Feature.NUMBER, NumberAgreement.SINGULAR);
		Assert.assertEquals(
				"cantei", realiser.realise(cantar).getRealisation());
		...
		cantar.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"cantamos", realiser.realise(cantar).getRealisation());
		...
		cantar.setFeature(Feature.NUMBER, NumberAgreement.SINGULAR);
		Assert.assertEquals(
				"canto", realiser.realise(cantar).getRealisation());
		...
		cantar.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"cantemos", realiser.realise(cantar).getRealisation());
		...
		cantar.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"cantarmos", realiser.realise(cantar).getRealisation());
		...
		cantar.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"cantássemos", realiser.realise(cantar).getRealisation());
	...
	public void testSecondConjugation(){
		...
		Assert.assertEquals(
				"venderíamos", realiser.realise(vender).getRealisation());
		...
		vender.setFeature(Feature.NUMBER, NumberAgreement.SINGULAR);
		Assert.assertEquals(
				"venderei", realiser.realise(vender).getRealisation());
		...
		vender.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"venderemos", realiser.realise(vender).getRealisation());
		...
		vender.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"vendíamos", realiser.realise(vender).getRealisation());
		...
		vender.setFeature(Feature.NUMBER, NumberAgreement.SINGULAR);
		Assert.assertEquals(
				"vendi", realiser.realise(vender).getRealisation());
		...
		vender.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"vendemos", realiser.realise(vender).getRealisation());
		...
		vender.setFeature(Feature.NUMBER, NumberAgreement.SINGULAR);
		Assert.assertEquals(
				"vendo", realiser.realise(vender).getRealisation());
		...
		vender.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"vendamos", realiser.realise(vender).getRealisation());
		...
		vender.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"vendermos", realiser.realise(vender).getRealisation());
		...
		vender.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"vendêssemos", realiser.realise(vender).getRealisation());
	...
	public void testThirdConjugation(){
		...
		Assert.assertEquals(
				"partiríamos", realiser.realise(partir).getRealisation());
		...
		partir.setFeature(Feature.NUMBER, NumberAgreement.SINGULAR);
		Assert.assertEquals(
				"partirei", realiser.realise(partir).getRealisation());
		...
		partir.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"partiremos", realiser.realise(partir).getRealisation());
		...
		partir.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"partíamos", realiser.realise(partir).getRealisation());
		...
		partir.setFeature(Feature.NUMBER, NumberAgreement.SINGULAR);
		Assert.assertEquals(
				"parti", realiser.realise(partir).getRealisation());
		...
		partir.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"partimos", realiser.realise(partir).getRealisation());
		...
		partir.setFeature(Feature.NUMBER, NumberAgreement.SINGULAR);
		Assert.assertEquals(
				"parto", realiser.realise(partir).getRealisation());
		...
		partir.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"partamos", realiser.realise(partir).getRealisation());
		...
		partir.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"partirmos", realiser.realise(partir).getRealisation());
		...
		partir.setFeature(Feature.NUMBER, NumberAgreement.PLURAL);
		Assert.assertEquals(
				"partíssemos", realiser.realise(partir).getRealisation());
