 ...
 * There are 3 initial examples to help users get started.
 * After those, users should create their own examples, to test the system. 
 *  
 */
public class Testbed extends Setup {
	...
	/**
	 * This example shows:
	 * a) -ão plural: folião + PLURAL = foliões
	 * b) -al plural: arraial + PLURAL = arraiais
	 * c) verb periphrasis build: foliões animados + gostar + brincar = foliões animados gostam de brincar
	 */
	@Test
	...
	/**
	 * This example shows:
	 * a) preposition contraction: em + uma = numa
	 * b) no preposition contraction: de + São João = de + São João
	 * d) preposition contraction: em + o = no
	 * e) preposition contraction: de + a = da
	 */
	@Test
