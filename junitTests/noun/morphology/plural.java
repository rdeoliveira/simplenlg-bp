...
public class plural extends Setup {
	...
	public void testPluralVowel(){
		...
		Assert.assertEquals(
				"livros", realiser.realise(livro).getRealisation());		
	}
	...
	public void testPluralCidadao(){
		...
		Assert.assertEquals(
				"cidadões", realiser.realise(cidadao).getRealisation());
...
//				"cidadãos", realiser.realise(cidadao).getRealisation());
	...
	public void testPluralCapitao(){
		...
		Assert.assertEquals(
				"capitões", realiser.realise(capitao).getRealisation());
				// TODO wrong output above; should be:
//				"capitães", realiser.realise(capitao).getRealisation());
	...
	public void testPluralLeao(){
		...
		Assert.assertEquals(
				"leões", realiser.realise(leao).getRealisation());
	}
	...
	public void testPluralPapel(){
		...
		Assert.assertEquals(
				"papeis", realiser.realise(papel).getRealisation());
				// TODO wrong output above; should be:
	...
	public void testPluralFossil(){
		...
		Assert.assertEquals(
				"fóssiis", realiser.realise(fossil).getRealisation());
				// TODO wrong output above; should be:
	...
	public void testPluralCarnaval(){
		...
		Assert.assertEquals(
				"carnavais", realiser.realise(carnaval).getRealisation());
	}
	...
	public void testPluralDom(){
		...
		Assert.assertEquals(
				"dons", realiser.realise(dom).getRealisation());		
	}
	...
	public void testPluralEspecimen(){
		...
		Assert.assertEquals(
				"espécimens", realiser.realise(especimen).getRealisation());		
	}
	...
	public void testPluralAbdomen(){
		...
		Assert.assertEquals(
				"abdômens", realiser.realise(abdomen).getRealisation());
				// TODO wrong output above; should be:
	...
	public void testPluralCor(){
		...
		Assert.assertEquals(
				"cores", realiser.realise(cor).getRealisation());		
	}
	...
	public void testPluralLapis(){
		...
		Assert.assertEquals(
				"lápis", realiser.realise(lapis).getRealisation());		
	}
	...
	public void testPluralFregues(){
		...
		Assert.assertEquals(
				"freguêses", realiser.realise(fregues).getRealisation());		
	}
	...
	public void testPluralTorax(){
		...
		Assert.assertEquals(
				"tórax", realiser.realise(torax).getRealisation());		
	}
	...
	public void testPluralLuz(){
		...
		Assert.assertEquals(
				"luzes", realiser.realise(luz).getRealisation());		
	}
	...
	public void testPluralJuiz(){
		...
		Assert.assertEquals(
				"juizes", realiser.realise(juiz).getRealisation());
				// TODO wrong output above; should be:
