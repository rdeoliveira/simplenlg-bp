...
/**
 * This lexicon compiler takes DELAF_PB (Muniz, 2004), an 880,000-entry lexicon of
 * inflected words in Brazilian Portuguese, and produces a lexicon XML output file in
 * SimpleNLG format.
 * 
...
public class delaf2simpleNLG {
	...
	public static void main(String[] args) throws IOException {
		...
		// Switch full lexicon for a sample to quickly test changes to this compiler.
		...
		// List of irregular verbs. Only these will be transferred to the XML file.
		// Add more verbs to this list to compile a new XML lexicon file.
		String[] irregularVerbs = {
				// -ar ending
				"estar","trancar","laçar","frear","largar","odiar","coroar","dar",
				"saudar","aguar", "averiguar", "adequar",
				// -er ending
				"ser","ter","haver","dizer","fazer","trazer","caber","saber","ver",
				"prover","poder","crer","querer","requerer","valer","perder","aprazer",
				"erguer","aquecer","jazer","abranger","roer",
				// -ir ending
				"cair","ir","vir","rir","ouvir","medir","conduzir","dirigir","extinguir",
				"seguir","conseguir","divergir","construir","coibir","frigir","arguir",
				"mentir","agredir","dormir","polir","umir","extorquir","falir"};
		// Compilation of above list to a hash set, for quick lookup.
		Set iv = new HashSet(Arrays.asList(irregularVerbs));
		...
		BufferedReader br = new BufferedReader(new FileReader(
				// Path to DELAF_PB file. May need to be edited for different OSs.
				"./lexiconCompiler/input/"+delafPBFile));
		@SuppressWarnings("resource")
		BufferedReader br2 = new BufferedReader(new FileReader(
				// Path to pronouns file. May need to be edited for different OSs.
			...
			if(entryM.find()){
				...
				if (pos.equals("V") && iv.contains(base)){
					if (!current.equals(base)){
						...
						fw.write(
								"\t<word><!-- "+base+"."+pos.toLowerCase()+" -->\n"+
								"\t\t<base>"+base+"</base>\n"+
								"\t\t<category>"+longPOS+"</category>\n"+
								"\t\t<id>"+base+"."+pos.toLowerCase()+"</id>\n");
						current = base;
						count++;
					}				
					...
					while(tagM.find()){
						...
						switch (tense) {
						// TODO double-check that these tense names are the same in sNLG 
						case "W": tense = "infinitive"; break;
						case "G": tense = "present_participle"; break;
						case "K": tense = "past_participle"; break;
						case "P": tense = "present"; break;
						case "I": tense = "imperfect"; break;
						case "J": tense = "past"; break;
						case "F": tense = "future"; break;
						case "Q": tense = "plu_perfect"; break;
						case "S": tense = "subjunctive_present"; break;
						case "T": tense = "subjunctive_imperfect"; break;
						case "U": tense = "subjunctive_future"; break;
						case "Y": tense = "imperative"; break;
						case "C": tense = "conditional"; break;
						}
						...
						if (tense.endsWith("participle") && inflected.endsWith("o")){
							...
							fw.write("\t\t<"+tense+personNumber+">"+inflected
									+"</"+tense+personNumber+">\n");
						}
					}
				}
