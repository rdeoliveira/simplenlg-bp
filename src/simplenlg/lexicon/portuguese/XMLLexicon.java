...
/**
 * Extension of simplenlg.lexicon.XMLLexicon for Portuguese.
 * 
 * @author vaudrypl
...
public class XMLLexicon extends simplenlg.lexicon.XMLLexicon {
	...
	public XMLLexicon(String filename) {
		super(Language.PORTUGUESE, filename);
	}
	...
	public XMLLexicon(File file) {
		super(Language.PORTUGUESE, file);
	}
	...
	public XMLLexicon(URI lexiconURI) {
		super(Language.PORTUGUESE, lexiconURI);
	}
	...
	protected WordElement convertNodeToWord(Node wordNode) {
		...
		// converts String to PronounType value for feature PortugueseLexicalFeature.PRONOUN_TYPE
		if (word.hasFeature(PortugueseLexicalFeature.PRONOUN_TYPE)) {
			String stringValue = word.getFeatureAsString(PortugueseLexicalFeature.PRONOUN_TYPE);
			PronounType pronounType = PronounType.valueOf(stringValue.toUpperCase());
			word.setFeature(PortugueseLexicalFeature.PRONOUN_TYPE, pronounType);
		}
